package ru.steeldv.nomenclature.aspect;
...
public class LoggingAspect {
     ...
     * @throws Throwable
     */
    @AfterReturning(value = "@annotation(ru.steeldv.nomenclature.aspect.annotation.CallingLog)")
     ...
     * @throws Throwable
     */
    @AfterReturning(value = "@annotation(ru.steeldv.nomenclature.aspect.annotation.ErrorLog)")

package ru.steeldv.library.aspect;
...
public class LoggingAspect {
     ...
     * @throws Throwable
     */
    @AfterReturning(value = "@annotation(ru.steeldv.library.aspect.annotation.CallingLog)")
     ...
     * @throws Throwable
     */
    @AfterReturning(value = "@annotation(ru.steeldv.library.aspect.annotation.ErrorLog)")
